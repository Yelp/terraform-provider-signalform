...
**NOTE:** Since every dashboard is included in a [dashboard group](docs/resources/dashbord_group.md) (SignalFx collection of dashboards), you need to create that first and reference it as shown in the example.
